...
int create_base_ext(glm::vec3 pos) {
	...
	base_ext.rb_handle = create_rigidbody(base_ext.transform_handle, false, base_extension_t::WIDTH, base_extension_t::HEIGHT, true, PHYSICS_RB_TYPE::NONE, false, true);
